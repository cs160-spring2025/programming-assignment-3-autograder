...
test(
  ...
  {
    annotation: { type: "points", description: ".25" },
  },
  async ({ page }) => {
...
test(
  ...
  {
    annotation: { type: "points", description: ".5" },
  },
  async ({ page }) => {
...
test(
  ...
  {
    annotation: { type: "points", description: "1.25" },
  },
  async ({ page }) => {
    await testBefore(page, ["Flip the bedroom light"]);
...
test(
  ...
  {
    annotation: { type: "points", description: "0.75" },
  },
  async ({ page }) => {
